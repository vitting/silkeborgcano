...
final _entities = <obx_int.ModelEntity>[
  ...
  obx_int.ModelEntity(
    ...
    relations: <obx_int.ModelRelation>[
      ...
      obx_int.ModelRelation(
        id: const obx_int.IdUid(9, 2379637432522516840),
        name: 'matches',
        targetId: const obx_int.IdUid(1, 7853952313064716528),
      ),
      obx_int.ModelRelation(
        id: const obx_int.IdUid(10, 2850712363210080507),
        name: 'sittingOver',
        targetId: const obx_int.IdUid(3, 7144689319236241690),
      ),
    ],
  ...
  obx_int.ModelEntity(
    ...
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 2749480986102639217),
        name: 'oid',
        type: 6,
        flags: 1,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 7226606603402525657),
        name: 'id',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 6781511918766741210),
        name: 'name',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(4, 3926126697949872689),
        name: 'currentRoundId',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(5, 1852881016437231851),
        name: 'pointPerMatch',
        type: 6,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(6, 4118136613542207595),
        name: 'tournamentEnd',
        type: 6,
        flags: 0,
      ),
    ...
    relations: <obx_int.ModelRelation>[
      obx_int.ModelRelation(
        id: const obx_int.IdUid(11, 1804834162487950617),
        name: 'playerTournamentPoints',
        targetId: const obx_int.IdUid(5, 2702153521453821823),
      ),
      obx_int.ModelRelation(
        id: const obx_int.IdUid(12, 920314484061299630),
        name: 'players',
        targetId: const obx_int.IdUid(3, 7144689319236241690),
      ),
      obx_int.ModelRelation(
        id: const obx_int.IdUid(13, 7610332901214771098),
        name: 'rounds',
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
    ...
    retiredEntityUids: const [1315279517998681009],
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    Match: obx_int.EntityDefinition<Match>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final courtNumberParam = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          14,
          0,
    ...
    MatchRound: obx_int.EntityDefinition<MatchRound>(
      ...
      toManyRelations: (MatchRound object) => {
        ...
        obx_int.RelInfo<MatchRound>.toMany(9, object.oid): object.matches,
        obx_int.RelInfo<MatchRound>.toMany(10, object.oid): object.sittingOver,
      },
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        obx_int.InternalToManyAccess.setRelInfo<MatchRound>(
          object.matches,
          store,
          obx_int.RelInfo<MatchRound>.toMany(9, object.oid),
        );
        obx_int.InternalToManyAccess.setRelInfo<MatchRound>(
          object.sittingOver,
          store,
          obx_int.RelInfo<MatchRound>.toMany(10, object.oid),
        );
        return object;
      },
    ),
    ...
    Tournament: obx_int.EntityDefinition<Tournament>(
      ...
      toManyRelations: (Tournament object) => {
        obx_int.RelInfo<Tournament>.toMany(11, object.oid):
            object.playerTournamentPoints,
        obx_int.RelInfo<Tournament>.toMany(12, object.oid): object.players,
        obx_int.RelInfo<Tournament>.toMany(13, object.oid): object.rounds,
      },
      ...
      objectToFB: (Tournament object, fb.Builder fbb) {
        ...
        fbb.addOffset(1, idOffset);
        fbb.addOffset(2, nameOffset);
        fbb.addOffset(3, currentRoundIdOffset);
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        obx_int.InternalToManyAccess.setRelInfo<Tournament>(
          object.players,
          store,
          obx_int.RelInfo<Tournament>.toMany(12, object.oid),
        );
        obx_int.InternalToManyAccess.setRelInfo<Tournament>(
          object.rounds,
          store,
          obx_int.RelInfo<Tournament>.toMany(13, object.oid),
        );
        return object;
      },
    ),
...
class Match_ {
  ...
  /// See [Match.matchRoundId].
  static final matchRoundId = obx.QueryStringProperty<Match>(
...
class MatchRound_ {
  ...
  static final matches = obx.QueryRelationToMany<MatchRound, Match>(
    _entities[1].relations[2],
  );

  /// see [MatchRound.sittingOver]
  static final sittingOver = obx.QueryRelationToMany<MatchRound, Player>(
...
class Tournament_ {
  ...
  /// See [Tournament.currentRoundId].
  static final currentRoundId = obx.QueryStringProperty<Tournament>(
